import { PrismaClient, Prisma, YieldUnit } from "@prisma/client";
import { CreateRecipeDto } from "../schemas/dtos/create-recipe.dto.js";
import { UpdateRecipeDto } from "../schemas/dtos/update-recipe.dto.js";
    ...
    async calculateForRecipe(
        ...
        for (const section of dto.sections) {
            ...
            for (const ingredient of section.ingredients) {
                ...
                if (nutrition.totalSugarsPer100g !== null) totalSugars += nutrition.totalSugarsPer100g * multiplier;
                if (nutrition.addedSugarsPer100g !== null) addedSugars += nutrition.addedSugarsPer100g * multiplier;
                if (nutrition.saturatedFatPer100g !== null) saturatedFat += nutrition.saturatedFatPer100g * multiplier;
        ...
        return {
            ...
            energyKcalDailyValuePercent: (totalEnergyKcal * perServingMultiplier / DAILY_VALUES.energyKcal) * 100,
            carbohydratesDailyValuePercent: (totalCarbohydrates * perServingMultiplier / DAILY_VALUES.carbohydrates) * 100,
            addedSugarsDailyValuePercent: (addedSugars * perServingMultiplier / DAILY_VALUES.addedSugars) * 100,
            proteinDailyValuePercent: (totalProtein * perServingMultiplier / DAILY_VALUES.protein) * 100,
            totalFatDailyValuePercent: (totalFat * perServingMultiplier / DAILY_VALUES.totalFat) * 100,
            saturatedFatDailyValuePercent: (saturatedFat * perServingMultiplier / DAILY_VALUES.saturatedFat) * 100,
