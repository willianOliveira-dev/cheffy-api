...
export const recipeSectionIngredientResponseSchema = z.object({
    id: z.string().uuid(),
...
export const preparationStepResponseSchema = z.object({
    id: z.string().uuid(),
...
export const recipeSectionResponseSchema = z.object({
    id: z.string().uuid(),
    title: z.string(),
    position: z.number(),
    recipeId: z.string().uuid(),
...
const baseRecipeSchema = {
    ...
    deletedAt: z.union([z.string(), z.date()]).nullable().openapi({ type: "string", format: "date-time" }),
    createdAt: z.union([z.string(), z.date()]).openapi({ type: "string", format: "date-time" }),
    updatedAt: z.union([z.string(), z.date()]).openapi({ type: "string", format: "date-time" }),
...
export const recipeSummaryResponseSchema = z.object({
    ...baseRecipeSchema,
    author: authorSchema,
