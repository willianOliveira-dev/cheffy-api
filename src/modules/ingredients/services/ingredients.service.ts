...
import { FindAllIngredientsDto } from "../schemas/dtos/find-all-ingredients.dto.js";
import { CreateIngredientDto } from "../schemas/dtos/create-ingredient.dto.js";
import { IngredientNutritionDto, UpdateIngredientNutritionDto } from "../schemas/dtos/ingredient-nutrition.dto.js";
import { UpdateIngredientDto } from "../schemas/dtos/update-ingredient.dto.js";
...
export class IngredientsService {
    ...
    async create(dto: CreateIngredientDto): Promise<Ingredient & { nutrition?: IngredientNutrition | null }> {
        ...
        return await this.repository.findById(ingredient.id) as Ingredient & { nutrition?: IngredientNutrition | null };
    }
    ...
    async update(id: string, dto: UpdateIngredientDto): Promise<Ingredient & { nutrition?: IngredientNutrition | null }> {
    ...
    async upsertNutrition(ingredientId: string, dto: IngredientNutritionDto): Promise<IngredientNutrition> {
        await this.getById(ingredientId);
    ...
    async updateNutrition(ingredientId: string, dto: UpdateIngredientNutritionDto): Promise<IngredientNutrition> {
        await this.getById(ingredientId);
